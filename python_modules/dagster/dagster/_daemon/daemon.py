...
TCtx = TypeVar("TCtx", bound=IWorkspaceProcessContext)


class DagsterDaemon(AbstractContextManager, ABC, Generic[TCtx]):
    def __init__(self):
    ...
    def run_daemon_loop(
        self,
        workspace_process_context: TCtx,
        daemon_uuid: str,
...
class IntervalDaemon(DagsterDaemon[TCtx], ABC):
    ...
    @abstractmethod
    def run_iteration(self, workspace_process_context: TCtx) -> TDaemonGenerator:
        ...
